var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		// 获取特定div作为背景
		// div是你想要将其作为背景的div的ID
		bgDiv = canvasConfig.div;
		if(bgDiv)
			body = document.getElementById(bgDiv);
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementById(bgDiv).style.width;
		var height = document.getElementById(bgDiv).style.height;
